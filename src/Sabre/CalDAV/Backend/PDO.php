...
namespace Club\Sabre\CalDAV\Backend;
...
class PDO extends AbstractBackend implements SyncSupport, SubscriptionSupport, SchedulingSupport {
     ...
     * @var string
     */
    public $calendarTableName = 'wp_club_calendars';
     ...
     * @var string
     */
    public $calendarObjectTableName = 'wp_club_calendarobjects';
     ...
     * @var string
     */
    public $calendarChangesTableName = 'wp_club_calendarchanges';
     ...
     * @var string
     */
    public $schedulingObjectTableName = 'wp_club_schedulingobjects';
     ...
     * @var string
     */
    public $calendarSubscriptionsTableName = 'wp_club_calendarsubscriptions';
