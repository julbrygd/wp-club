...
namespace Club\Sabre\CardDAV\Backend;
...
class PDO extends AbstractBackend implements SyncSupport {
     ...
     */
    public $addressBooksTableName = 'wp_club_addressbooks';

    /**
     * The PDO table name used to store cards
     */
    public $cardsTableName = 'wp_club_cards';
     ...
     * @var string
     */
    public $addressBookChangesTableName = 'wp_club_addressbookchanges';
