...
class WordpressAcl extends AbstractBackend implements CreatePrincipalSupport {
     ...
     * @var string
     */
    public $tableName = 'wp_club_principals';
     ...
     * @var string
     */
    public $groupMembersTableName = 'wp_club_groupmembers';
